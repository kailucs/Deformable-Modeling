...
def run_collection_process_PCD():
	II = 4
	####### Process Pcd data ###############
	#originalPcd = read_point_cloud("calibration_data/objectScan_phantom.xyzrgb",format='xyzrgb')
	originalPcd = read_point_cloud("experiment_data/objectScan_"+str(II)+".xyzrgb",format='xyzrgb')
	...
	write_point_cloud("experiment_data/processed/objectScan_"+str(II)+".pcd",pcdSegmented)
