...
def main():
    ...
    for downsample_rate in [1,2,4,8,16,32,64,128]:
        ...
        #uniform downsample
        X_train = X_train[::downsample_rate]
        X_test = X_test[::downsample_rate]
        y_train = y_train[::downsample_rate]
